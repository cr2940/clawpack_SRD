...
f2py_start_clock();
  ...
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOOOOOOO|OOO:advection_2d.rpn2",\
...
/*frompyobj*/
  ...
  /* Processing variable mbc */
    f2py_success = int_from_pyobj(&mbc,mbc_capi,"advection_2d.rpn2() 3rd argument (mbc) can't be converted to int");
  if (f2py_success) {
  /* Processing variable mx */
    f2py_success = int_from_pyobj(&mx,mx_capi,"advection_2d.rpn2() 4th argument (mx) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_ql_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(advection_2d_error,"failed in converting 5th argument `ql' of advection_2d.rpn2 to C/Fortran array" );
  } else {
  ...
  if (capi_auxl_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(advection_2d_error,"failed in converting 7th argument `auxl' of advection_2d.rpn2 to C/Fortran array" );
  } else {
  ...
  if (maux_capi == Py_None) maux = shape(auxl,0); else
    f2py_success = int_from_pyobj(&maux,maux_capi,"advection_2d.rpn2() 3rd keyword (maux) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_wave_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(advection_2d_error,"failed in converting 9th argument `wave' of advection_2d.rpn2 to C/Fortran array" );
  } else {
  ...
  if (capi_qr_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(advection_2d_error,"failed in converting 6th argument `qr' of advection_2d.rpn2 to C/Fortran array" );
  } else {
  ...
  if (capi_apdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(advection_2d_error,"failed in converting 12nd argument `apdq' of advection_2d.rpn2 to C/Fortran array" );
  } else {
  ...
  if (capi_amdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(advection_2d_error,"failed in converting 11st argument `amdq' of advection_2d.rpn2 to C/Fortran array" );
  } else {
  ...
  if (capi_auxr_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(advection_2d_error,"failed in converting 8th argument `auxr' of advection_2d.rpn2 to C/Fortran array" );
  } else {
  ...
  if (capi_s_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(advection_2d_error,"failed in converting 10th argument `s' of advection_2d.rpn2 to C/Fortran array" );
  } else {
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOOOOOOOOOOO:advection_2d.rpt2",\
...
/*frompyobj*/
  ...
  if (f2py_success) {
  /* Processing variable meqn */
    f2py_success = int_from_pyobj(&meqn,meqn_capi,"advection_2d.rpt2() 4th argument (meqn) can't be converted to int");
  if (f2py_success) {
  /* Processing variable mwaves */
    f2py_success = int_from_pyobj(&mwaves,mwaves_capi,"advection_2d.rpt2() 5th argument (mwaves) can't be converted to int");
  if (f2py_success) {
  /* Processing variable maux */
    f2py_success = int_from_pyobj(&maux,maux_capi,"advection_2d.rpt2() 6th argument (maux) can't be converted to int");
  if (f2py_success) {
  /* Processing variable mbc */
    f2py_success = int_from_pyobj(&mbc,mbc_capi,"advection_2d.rpt2() 7th argument (mbc) can't be converted to int");
  if (f2py_success) {
  /* Processing variable mx */
    f2py_success = int_from_pyobj(&mx,mx_capi,"advection_2d.rpt2() 8th argument (mx) can't be converted to int");
  if (f2py_success) {
  /* Processing variable ql */
    f2py_success = double_from_pyobj(&ql,ql_capi,"advection_2d.rpt2() 9th argument (ql) can't be converted to double");
  if (f2py_success) {
  /* Processing variable qr */
    f2py_success = double_from_pyobj(&qr,qr_capi,"advection_2d.rpt2() 10th argument (qr) can't be converted to double");
  if (f2py_success) {
  /* Processing variable aux1 */
    f2py_success = double_from_pyobj(&aux1,aux1_capi,"advection_2d.rpt2() 11st argument (aux1) can't be converted to double");
  if (f2py_success) {
  /* Processing variable aux2 */
    f2py_success = double_from_pyobj(&aux2,aux2_capi,"advection_2d.rpt2() 12nd argument (aux2) can't be converted to double");
  if (f2py_success) {
  /* Processing variable aux3 */
    f2py_success = double_from_pyobj(&aux3,aux3_capi,"advection_2d.rpt2() 13rd argument (aux3) can't be converted to double");
  if (f2py_success) {
  /* Processing variable asdq */
    f2py_success = double_from_pyobj(&asdq,asdq_capi,"advection_2d.rpt2() 14th argument (asdq) can't be converted to double");
  if (f2py_success) {
  /* Processing variable bmasdq */
    f2py_success = double_from_pyobj(&bmasdq,bmasdq_capi,"advection_2d.rpt2() 15th argument (bmasdq) can't be converted to double");
  if (f2py_success) {
  /* Processing variable bpasdq */
    f2py_success = double_from_pyobj(&bpasdq,bpasdq_capi,"advection_2d.rpt2() 16th argument (bpasdq) can't be converted to double");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
