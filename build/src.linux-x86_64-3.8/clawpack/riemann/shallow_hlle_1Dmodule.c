...
static PyObject *shallow_hlle_1D_error;
static PyObject *shallow_hlle_1D_module;
...
#define CHECKSCALAR(check,tcheck,name,show,var)\
    if (!(check)) {\
        ...
        PyErr_SetString(shallow_hlle_1D_error,errstring);\
        /*goto capi_fail;*/\
    } else 
#ifdef DEBUGCFUNCS
...
static int int_from_pyobj(int* v,PyObject *obj,const char *errmess) {
    ...
    }
    {
        ...
        if (err==NULL) err = shallow_hlle_1D_error;
...
/************************************ rp1 ************************************/
static char doc_f2py_rout_shallow_hlle_1D_rp1[] = "\
...
/* extern void F_FUNC(rp1,RP1)(int*,int*,int*,int*,int*,int*,double*,double*,double*,double*,double*,double*,double*,double*); */
static PyObject *f2py_rout_shallow_hlle_1D_rp1(const PyObject *capi_self,
                           PyObject *capi_args,
...
f2py_start_clock();
  ...
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOOO|OO:shallow_hlle_1D.rp1",\
...
/*frompyobj*/
  /* Processing variable maxmx */
    f2py_success = int_from_pyobj(&maxmx,maxmx_capi,"shallow_hlle_1D.rp1() 1st argument (maxmx) can't be converted to int");
  if (f2py_success) {
  /* Processing variable mwaves */
    f2py_success = int_from_pyobj(&mwaves,mwaves_capi,"shallow_hlle_1D.rp1() 2nd argument (mwaves) can't be converted to int");
  if (f2py_success) {
  /* Processing variable mbc */
    f2py_success = int_from_pyobj(&mbc,mbc_capi,"shallow_hlle_1D.rp1() 3rd argument (mbc) can't be converted to int");
  if (f2py_success) {
  /* Processing variable mx */
    f2py_success = int_from_pyobj(&mx,mx_capi,"shallow_hlle_1D.rp1() 4th argument (mx) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_ql_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(shallow_hlle_1D_error,"failed in converting 5th argument `ql' of shallow_hlle_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_auxl_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(shallow_hlle_1D_error,"failed in converting 7th argument `auxl' of shallow_hlle_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_s_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(shallow_hlle_1D_error,"failed in converting hidden `s' of shallow_hlle_1D.rp1 to C/Fortran array" );
  } else {
    s = (double *)(PyArray_DATA(capi_s_tmp));

  /* Processing variable meqn */
  if (meqn_capi == Py_None) meqn = shape(ql,0); else
    f2py_success = int_from_pyobj(&meqn,meqn_capi,"shallow_hlle_1D.rp1() 1st keyword (meqn) can't be converted to int");
  if (f2py_success) {
  ...
  if (maux_capi == Py_None) maux = shape(auxl,0); else
    f2py_success = int_from_pyobj(&maux,maux_capi,"shallow_hlle_1D.rp1() 2nd keyword (maux) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_qr_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(shallow_hlle_1D_error,"failed in converting 6th argument `qr' of shallow_hlle_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_auxr_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(shallow_hlle_1D_error,"failed in converting 8th argument `auxr' of shallow_hlle_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_wave_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(shallow_hlle_1D_error,"failed in converting hidden `wave' of shallow_hlle_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_amdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(shallow_hlle_1D_error,"failed in converting hidden `amdq' of shallow_hlle_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_apdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(shallow_hlle_1D_error,"failed in converting hidden `apdq' of shallow_hlle_1D.rp1 to C/Fortran array" );
  } else {
...
static FortranDataDef f2py_routine_defs[] = {
  {"rp1",-1,{{-1}},0,(char *)F_FUNC(rp1,RP1),(f2py_init_func)f2py_rout_shallow_hlle_1D_rp1,doc_f2py_rout_shallow_hlle_1D_rp1},
...
#if PY_VERSION_HEX >= 0x03000000
#define RETVAL m
PyMODINIT_FUNC PyInit_shallow_hlle_1D(void) {
#else
#define RETVAL
PyMODINIT_FUNC initshallow_hlle_1D(void) {
#endif
  int i;
  PyObject *m,*d, *s, *tmp;
#if PY_VERSION_HEX >= 0x03000000
  m = shallow_hlle_1D_module = PyModule_Create(&moduledef);
#else
  m = shallow_hlle_1D_module = Py_InitModule("shallow_hlle_1D", f2py_module_methods);
#endif
  Py_TYPE(&PyFortran_Type) = &PyType_Type;
  import_array();
  if (PyErr_Occurred())
    {PyErr_SetString(PyExc_ImportError, "can't initialize module shallow_hlle_1D (failed to import numpy)"); return RETVAL;}
...
#endif
    "This module 'shallow_hlle_1D' is auto-generated with f2py (version:2).\nFunctions:\n"
"  wave,s,amdq,apdq = rp1(maxmx,mwaves,mbc,mx,ql,qr,auxl,auxr,meqn=shape(ql,0),maux=shape(auxl,0))\n"
"COMMON blocks:\n""  /cparam/ grav\n"".");
  PyDict_SetItemString(d, "__doc__", s);
  Py_DECREF(s);
  shallow_hlle_1D_error = PyErr_NewException ("shallow_hlle_1D.error", NULL, NULL);
  /*
   * Store the error object inside the dict, so that it could get deallocated.
   * (in practice, this is a module, so it likely will not and cannot.)
   */
  PyDict_SetItemString(d, "_shallow_hlle_1D_error", shallow_hlle_1D_error);
  Py_DECREF(shallow_hlle_1D_error);
...
#ifdef F2PY_REPORT_ATEXIT
  if (! PyErr_Occurred())
    on_exit(f2py_report_on_exit,(void*)"shallow_hlle_1D");
#endif
  return RETVAL;
}
#ifdef __cplusplus
