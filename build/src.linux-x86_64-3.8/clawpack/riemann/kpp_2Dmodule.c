...
/*frompyobj*/
  ...
  /* Processing variable auxl */
    f2py_success = double_from_pyobj(&auxl,auxl_capi,"kpp_2D.rpn2() 8th argument (auxl) can't be converted to double");
  if (f2py_success) {
  /* Processing variable auxr */
    f2py_success = double_from_pyobj(&auxr,auxr_capi,"kpp_2D.rpn2() 9th argument (auxr) can't be converted to double");
  if (f2py_success) {
...
".");
   ...
   */
  PyDict_SetItemString(d, "_kpp_2D_error", kpp_2D_error);
  Py_DECREF(kpp_2D_error);
