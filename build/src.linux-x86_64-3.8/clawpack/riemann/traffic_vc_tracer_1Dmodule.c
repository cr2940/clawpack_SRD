/* File: traffic_vc_tracer_1Dmodule.c
...
static PyObject *traffic_vc_tracer_1D_error;
static PyObject *traffic_vc_tracer_1D_module;
...
#define CHECKSCALAR(check,tcheck,name,show,var)\
    if (!(check)) {\
        ...
        PyErr_SetString(traffic_vc_tracer_1D_error,errstring);\
        /*goto capi_fail;*/\
    } else 
#ifdef DEBUGCFUNCS
...
static int int_from_pyobj(int* v,PyObject *obj,const char *errmess) {
    ...
    }
    {
        ...
        if (err==NULL) err = traffic_vc_tracer_1D_error;
...
/************************************ rp1 ************************************/
static char doc_f2py_rout_traffic_vc_tracer_1D_rp1[] = "\
...
"\nReturns\n-------\n"
"wave : rank-3 array('d') with bounds (num_eqn,num_waves,num_cells+num_ghost-(1-num_ghost)+1)\n"
...
/* extern void F_FUNC(rp1,RP1)(int*,int*,int*,int*,int*,int*,double*,double*,double*,double*,double*,double*,double*,double*); */
static PyObject *f2py_rout_traffic_vc_tracer_1D_rp1(const PyObject *capi_self,
                           PyObject *capi_args,
...
f2py_start_clock();
  ...
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOOO|OO:traffic_vc_tracer_1D.rp1",\
...
/*frompyobj*/
  /* Processing variable maxm */
    f2py_success = int_from_pyobj(&maxm,maxm_capi,"traffic_vc_tracer_1D.rp1() 1st argument (maxm) can't be converted to int");
  if (f2py_success) {
  /* Processing variable num_waves */
    f2py_success = int_from_pyobj(&num_waves,num_waves_capi,"traffic_vc_tracer_1D.rp1() 2nd argument (num_waves) can't be converted to int");
  if (f2py_success) {
  /* Processing variable num_ghost */
    f2py_success = int_from_pyobj(&num_ghost,num_ghost_capi,"traffic_vc_tracer_1D.rp1() 3rd argument (num_ghost) can't be converted to int");
  if (f2py_success) {
  /* Processing variable num_cells */
    f2py_success = int_from_pyobj(&num_cells,num_cells_capi,"traffic_vc_tracer_1D.rp1() 4th argument (num_cells) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_ql_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(traffic_vc_tracer_1D_error,"failed in converting 5th argument `ql' of traffic_vc_tracer_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_auxl_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(traffic_vc_tracer_1D_error,"failed in converting 7th argument `auxl' of traffic_vc_tracer_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_s_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(traffic_vc_tracer_1D_error,"failed in converting hidden `s' of traffic_vc_tracer_1D.rp1 to C/Fortran array" );
  } else {
    s = (double *)(PyArray_DATA(capi_s_tmp));

  /* Processing variable num_eqn */
  if (num_eqn_capi == Py_None) num_eqn = shape(ql,0); else
    f2py_success = int_from_pyobj(&num_eqn,num_eqn_capi,"traffic_vc_tracer_1D.rp1() 1st keyword (num_eqn) can't be converted to int");
  if (f2py_success) {
  ...
  if (num_aux_capi == Py_None) num_aux = shape(auxl,0); else
    f2py_success = int_from_pyobj(&num_aux,num_aux_capi,"traffic_vc_tracer_1D.rp1() 2nd keyword (num_aux) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_qr_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(traffic_vc_tracer_1D_error,"failed in converting 6th argument `qr' of traffic_vc_tracer_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_auxr_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(traffic_vc_tracer_1D_error,"failed in converting 8th argument `auxr' of traffic_vc_tracer_1D.rp1 to C/Fortran array" );
  } else {
    auxr = (double *)(PyArray_DATA(capi_auxr_tmp));

  /* Processing variable wave */
  wave_Dims[0]=num_eqn,wave_Dims[1]=num_waves,wave_Dims[2]=num_cells+num_ghost-(1-num_ghost)+1;
  ...
  if (capi_wave_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(traffic_vc_tracer_1D_error,"failed in converting hidden `wave' of traffic_vc_tracer_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_amdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(traffic_vc_tracer_1D_error,"failed in converting hidden `amdq' of traffic_vc_tracer_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_apdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(traffic_vc_tracer_1D_error,"failed in converting hidden `apdq' of traffic_vc_tracer_1D.rp1 to C/Fortran array" );
  } else {
...
#endif
/*callfortranroutine*/
        (*f2py_func)(&maxm,&num_eqn,&num_waves,&num_aux,&num_ghost,&num_cells,ql,qr,auxl,auxr,wave,s,amdq,apdq);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
...
static FortranDataDef f2py_routine_defs[] = {
  {"rp1",-1,{{-1}},0,(char *)F_FUNC(rp1,RP1),(f2py_init_func)f2py_rout_traffic_vc_tracer_1D_rp1,doc_f2py_rout_traffic_vc_tracer_1D_rp1},
...
#if PY_VERSION_HEX >= 0x03000000
#define RETVAL m
PyMODINIT_FUNC PyInit_traffic_vc_tracer_1D(void) {
#else
#define RETVAL
PyMODINIT_FUNC inittraffic_vc_tracer_1D(void) {
#endif
  int i;
  PyObject *m,*d, *s, *tmp;
#if PY_VERSION_HEX >= 0x03000000
  m = traffic_vc_tracer_1D_module = PyModule_Create(&moduledef);
#else
  m = traffic_vc_tracer_1D_module = Py_InitModule("traffic_vc_tracer_1D", f2py_module_methods);
#endif
  Py_TYPE(&PyFortran_Type) = &PyType_Type;
  import_array();
  if (PyErr_Occurred())
    {PyErr_SetString(PyExc_ImportError, "can't initialize module traffic_vc_tracer_1D (failed to import numpy)"); return RETVAL;}
...
#endif
    "This module 'traffic_vc_tracer_1D' is auto-generated with f2py (version:2).\nFunctions:\n"
"  wave,s,amdq,apdq = rp1(maxm,num_waves,num_ghost,num_cells,ql,qr,auxl,auxr,num_eqn=shape(ql,0),num_aux=shape(auxl,0))\n"
".");
  PyDict_SetItemString(d, "__doc__", s);
  Py_DECREF(s);
  traffic_vc_tracer_1D_error = PyErr_NewException ("traffic_vc_tracer_1D.error", NULL, NULL);
  /*
   * Store the error object inside the dict, so that it could get deallocated.
   * (in practice, this is a module, so it likely will not and cannot.)
   */
  PyDict_SetItemString(d, "_traffic_vc_tracer_1D_error", traffic_vc_tracer_1D_error);
  Py_DECREF(traffic_vc_tracer_1D_error);
...
#ifdef F2PY_REPORT_ATEXIT
  if (! PyErr_Occurred())
    on_exit(f2py_report_on_exit,(void*)"traffic_vc_tracer_1D");
#endif
  return RETVAL;
}
#ifdef __cplusplus
